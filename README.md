...
[![Go Report](https://goreportcard.com/badge/gitlab.com/locatemybeer/lmb-back)](https://goreportcard.com/report/gitlab.com/locatemybeer/lmb-back)
...
go get gitlab.com/locatemybeer/lmb-back
...
* move the directory `$GOPATH/gitlab.com/locatemybeer/lmb-back` to `$GOPATH/github.com/abc/xyz`
* do a global replacement of the string `gitlab.com/locatemybeer/lmb-back` in all of
